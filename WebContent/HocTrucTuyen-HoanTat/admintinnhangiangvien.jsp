          ...
          <tr>
            <%
		           ...
		           Statement st = con.createStatement();
				    ResultSet rs;
				    rs = st.executeQuery("select * from nhantin ");
				    while(rs.next()){
						%>
						<tr>
							
						<td><%=rs.getString("nguoigui") %></td>	
						<td><%=rs.getString("ngaygui") %></td>	
						<td><%=rs.getString("noidung") %></td>	
						<td><a  href="admintraloi.jsp?nguoigui=<%=rs.getString("nguoigui") %>" role="button">Trả lời </a></td>			
						</tr>
						<% 
						}
           ...
           <p><a href="admintrangchu.jsp#" class="btn btn-default" role="button">Quay lai</a></p>
        </div>
