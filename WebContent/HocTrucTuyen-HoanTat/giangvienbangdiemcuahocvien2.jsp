      ...
      <li class="#"><a href="giangvientrangchu.jsp#">Trang chủ </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="Thongtingiangvien.jsp#">Thông tin cá nhân</a></li>
  ...
  <div class="row content">
   ...
   <div class="col-sm-8 text-left">
    ...
    <h2 style="text-align: center">Bảng điểm</h2>
        ...
        <table class="table table-bordered" action="giangvienmokhoahoc3.jsp" method="post">
    <thead>
      <tr>
       <th>Tên học viên</th>
    ...
    <tbody>
      <tr>
         ...
         <th><input type="text" class="form-control" name="diemquatrinh"></th>	
         <th><input type="text" class="form-control" name="diemcuoiki"></th>	
         <th><input type="text" class="form-control" name="diemtrungbinh"></th>	
      </tr>
      <tr>
         <th>pham cao</th>	
