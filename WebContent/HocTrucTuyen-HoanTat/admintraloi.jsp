...
<div class="container-fluid text-left">
  <div class="row content">
    ...
    <form method="post" action="admintinnhanregistration.jsp">
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" rows="5" type="text" name="noidung" value="" ></textarea>
    </div>
          </div>
           <p><button href="adminhoantat.jsp#">Gửi</button></p>
        </div>
</form>
      </div>
    </div>
