...
<nav class="navbar navbar-collapse navbar-collapse">
  ...
  <form>
    ...
    <div class="text-left">
      ...
      <form class="form-horizontal"  method="post" action="hocvienlogin.jsp">
        <div class="form-group">
        ...
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            <a href="hocvientrangchu.jsp" target="_blank"><input class="btn btn-primary" type="submit" value="Đăng nhập"  class="button"></a>
           <tr>
              <td colspan="2">Bạn chưa có tài khoản!! <a href="hocviendangki.jsp">Đăng ký tại đây</a></td>
          </tr>
          </div>
