    ...
    <div class="text-left">
      ...
      <form class="form-horizontal" method="post" action="adminlogin.jsp">
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" name="uname" value="" placeholder="Enter uname">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            <a href="admintrangchu.jsp" target="_blank"><input class="btn btn-primary" type="submit" value="Đăng Nhập" class="button"></a>        
           <tr>
              <td colspan="2">Bạn chưa có tài khoản!! <a href="admindangki.jsp">Đăng ký tại đây</a></td>
          </tr>
          </div>
        </div>
        </p>
