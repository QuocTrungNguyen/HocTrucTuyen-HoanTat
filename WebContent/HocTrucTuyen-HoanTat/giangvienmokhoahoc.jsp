...
<div class="container-fluid text-left">
  <div class="row content">
    ...
    <form class="list", class="form-inline" action="giangvienmokhoahoc2.jsp" method="post">
      <div class="form-group">
        <p><label >Mã khóa học:</label>
        <input type="text" class="form-control" name="makh"></p>
        <label >Tên khóa học:</label>
        <input type="text" class="form-control" name="tenkhoahoc"></p>
        <p><label>Phòng</label>
        <input type="text" class="form-control" name="phong"></p>
        <p><label >Ngày bắt đầu:</label>
        <input type="text" class="form-control" name="ngaybatdau"></p>
        <p><label >Ngày kết thúc:</label>
        <input type="text" class="form-control" name="ngayketthuc"></p>
        <p><label>Thông tin:</label>
        <input type="text" class="form-control" name="thongtin"></p>
      </div>
