      ...
      <li class="#"><a href="trangchu.html#">Trang chủ </a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="hocviendangki.html#">Đăng ký</a></li>
    ...
    <div class="text-left">
      ...
      <form class="form-horizontal">
       <div class="form-group">
        ...
        <p><a href="trangchu.html#" class="btn btn-default" role="button">Hủy</a> <a href="trangchu.html#" class="btn btn-primary" role="button">Hoàn tất</a></p>
        </div>
        </p>
      </form>
