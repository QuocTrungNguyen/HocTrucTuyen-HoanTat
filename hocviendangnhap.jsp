  ...
  <form>
    ...
    <div class="text-left">
      ...
      <ul class="pagination">
        ...
        <li><a href="giangviendangnhap.html">Giảng viên</a></li>
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group"> 
          <div class="col-sm-offset-2 col-sm-10">
            <a href="hocvientrangchu.html" target="_blank"><input class="btn btn-primary" type="button" value="Đăng Nhập" class="button"></a>
          </div>
        </div>
        </p>
      </form>
