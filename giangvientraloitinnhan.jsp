...
<div class="container-fluid text-left">
  <div class="row content">
   ...
   <p><a href="giangvientinnhanchitiet.html#"><button type="submit" class="btn btn-primary">Quay lại</button></a><a href="giangvienhoantat.html#"><button type="submit" class="btn btn-primary">Gửi</button></a></p>
