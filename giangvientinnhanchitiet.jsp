     ...
     <ul class="nav nav-pills nav-stacked">
      ...
      <div class="col-sm-6 col-md-6">
        <div >
          ...
          <p><a href="giangvientinnhan.html#" class="btn btn-primary" role="button">Quay lai</a> <a href="giangvientraloitinnhan.html#" class="btn btn-primary" role="button">Trả lời</a></p>
