 ...
 <table class="table table-bordered">
    ...
    <tbody>
      <tr>
        ...
        <td>A4</td>
        <td>11/3/2017</td>
        <td><a href="hocviendanhgiachitiet.html#" target="_blank" title="n"><đánh giá></a></td>
      </tr>
      <tr>
      ...
      <hr>
      <a href="hocvientrangchu.html#"><button type="submit" class="btn btn-primary">Quay lại</button></a>
